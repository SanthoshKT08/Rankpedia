	...
	public static Response response;
	 @Given("^Student enter the OTP payload$")
		...
		login = new StudentLogin();
	       verifyOTPreq= given().spec(requestSpecification().body(data.VerifyotpPayload("9788304403",com.Rankpedia.StepDefinitions.StudentLogin.OTP )));
	    }
